...
class TransactionHistoryService {
  ...
  private getContractName(address: string): string {
    ...
    const contractNames: { [key: string]: string } = {
      ...
      '0x0A8862B2d93105b6BD63ee2c9343E7966872a3D2': 'chain-guardGold',
      '0x877D1FDa6a6b668b79ca4A42388E0825667d233E': 'chain-guardHero',
      '0xa5046538c6338DC8b52a22675338a4623D4B5475': 'chain-guardLoot',
      '0xeF85822c30D194c2B2F7cC17223C64292Bfe611b': 'chain-guardReward'
    };
