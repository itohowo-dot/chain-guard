...
interface Usechain-guardRewardOptions {
...
export function usechain-guardReward({ paymentInNative = true, poolId = 0, price = '0.01', onSuccess, onError }: Usechain-guardRewardOptions = {}) {
