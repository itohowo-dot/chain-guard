          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white ${
                reward.rewardType === 'chain-guardGold' ? 'bg-yellow-500' :
                reward.rewardType === 'chain-guardHero' ? 'bg-purple-500' : 'bg-blue-500'
              }`}>
                {reward.rewardType === 'chain-guardGold' ? '🪙' :
                 reward.rewardType === 'chain-guardHero' ? '🦸' : '⚔️'}
              </div>
              <div>
